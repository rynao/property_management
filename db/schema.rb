...
ActiveRecord::Schema.define(version: 2022_03_01_024225) do
  ...
  create_table "management_companies", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
